...
--> statement-breakpoint
CREATE UNIQUE INDEX "run_tokens_token_hash_idx" ON "run_tokens" ("token_hash");
--> statement-breakpoint
CREATE INDEX "run_events_run_id_sequence_idx" ON "run_events" ("run_id", "sequence");
--> statement-breakpoint
CREATE UNIQUE INDEX "run_completions_run_id_idempotency_key_idx"
  ON "run_completions" ("run_id", "idempotency_key");
--> statement-breakpoint
CREATE INDEX "run_completions_run_id_created_at_idx"
  ON "run_completions" ("run_id", "created_at");
--> statement-breakpoint
CREATE INDEX "run_artifacts_run_id_idx" ON "run_artifacts" ("run_id");
--> statement-breakpoint
CREATE INDEX "run_payloads_runtime_idx" ON "run_payloads" ("runtime");

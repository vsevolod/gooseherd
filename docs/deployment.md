...
On first launch, the setup wizard prompts you to set a dashboard password. This password is stored as a bcrypt hash in PostgreSQL.

For production, you can also set a token via environment variable (overrides the wizard password):
